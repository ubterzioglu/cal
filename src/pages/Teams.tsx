  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Seo
        ...
        description="Cağaloğlu Anadolu Lisesi öğrenci takımlarını keşfet ve destek ol."
        path="/takimlar"
        jsonLd={[
          breadcrumbSchema([
            { name: "Ana Sayfa", path: "/" },
            { name: "Öğrenci Takımları", path: "/takimlar" },
          ]),
          collectionPageSchema("Öğrenci Takımları", "/takimlar"),
        ]}
      />
      <Header />
